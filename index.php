...
<html lang="eo">
  ...
  <body>
    ...
    <form>
      ...
      <div class="mb-3">
        <label>Mi ŝatus mendi belegan IJK-ĉemizon</label>
        <select name="chemizo" id="kampo-chemizo" class="form-select" required>
          <option name="ne" selected>Ne, dankon</option>
          <option name="S" selected>Grandeco S</option>
          <option name="M" selected>Grandeco M</option>
          <option name="L" selected>Grandeco L</option>
          <option name="XL" selected>Grandeco XL</option>
          <option name="XXL" selected>Grandeco XXL</option>
        </select>
      </div>

      <div class="mb-3">
        <label for="kampo-nomo">Mi donacas al la IJK …</label>
        <div class="input-group mb-3">
          <span class="input-group-text">€</span>
          <input name="nomo" id="kampo-nomo" class="form-control" type="number" step="0.01" min="0" max="10000" value="0">
        </div>
        <div class="form-text">
