  ...
  <body>
      ...
      <form method="post" action="alighi.php">
        ...
        <div class="mb-3 form-check form-switch">
          ...
          <div class="form-text">
            Se vi estas individua membro aŭ patrono de TEJO vi ne pagos malrabaton de €50. <a href="https://uea.org/alighoj/alighilo">Estas pli malmultekoste aliĝi al TEJO</a> ol ricevi malrabaton.
          </div>
        </div>
